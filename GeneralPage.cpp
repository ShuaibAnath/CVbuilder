...
{// Personal details button pressed
	this->Hide();
	PersonalDetails^ PD = gcnew PersonalDetails(User::UserEmail);
	PD->ShowDialog();
}
...
{//education button clicked 
	...
	EducationForm->Show();
	ReusableCategoryBox::Heading = L"EDUCATION";
}
...
{//Project Button pressed 
	...
	ProjectForm->Show();
	ReusableCategoryBox::Heading = L"PROJECT";
}
...
{//work button clicked
	...
	WorkForm->Show();
	ReusableCategoryBox::Heading = L"WORK";
}
